...
def get_pos(keyPoints):
    ...
    if keyPoints[15][2] > keyPoints[11][2] and keyPoints[16][2] < keyPoints[12][2]:
        Str_pose = "Left_up"
    if keyPoints[16][2] > keyPoints[12][2] and keyPoints[15][2] < keyPoints[11][2]:
        Str_pose = "Right_up"
    if keyPoints[16][2] > keyPoints[12][2] and keyPoints[15][2] > keyPoints[11][2]:
        Str_pose = "Normal"
    if keyPoints[16][2] < keyPoints[12][2] and keyPoints[15][2] < keyPoints[11][2]:
...
def process_frame(img):
    ...
    if results.pose_landmarks:
        ...
        for i in range(33):
            ...
            cz = int(results.pose_landmarks.landmark[i].y * 480)
            if cx > x_max:
                x_max = cx
            if cx < x_min:
                x_min = cx
