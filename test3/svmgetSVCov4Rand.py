...
# # 定义超参搜索空间
# distributions = {'kernel': ['rbf', 'linear', 'poly'], 'C': np.logspace(-1, 1, 1000), 'gamma': np.linspace(1, 100, 1000),
#                  'decision_function_shape': ['ovo', 'ovr'], 'degree': [1, 2, 3, 4, 5]}

# # 定义超参搜索空间
distributions = {'kernel': ['poly'], 'C': np.logspace(-1, 1, 10000),
                 'decision_function_shape': ['ovo', 'ovr'], 'degree': [2, 3, 4]}

# # 定义超参搜索空间
# distributions = {'kernel': ['rbf'], 'C': np.logspace(-1, 1, 10000), 'gamma': np.logspace(-7, -3, 10000),
#                  'decision_function_shape': ['ovo', 'ovr']}

# distributions = {'kernel': ['linear'], 'C': np.logspace(-1, 1, 10000), 'decision_function_shape': ['ovo', 'ovr']}
...
print('最佳分数:\n', clf.best_score_)
print('最佳参数:\n', clf.best_params_)
joblib.dump(clf, 'D:\\opencv\\trainner\\clfSVCov4Rand.model')
